...
@Mod("mcaic")
public class McaicMod {
	public static final Logger LOGGER = LogManager.getLogger(McaicMod.class);
	...
	public McaicMod() {
		...
		McaicModSounds.REGISTRY.register(bus);
		McaicModBlocks.REGISTRY.register(bus);
		McaicModItems.REGISTRY.register(bus);
